...
Scale is one of the components of the grammar of graphics.
...
p_scales +
    ...
    scale_colour_continuous(
        trans  = "log10", 
        breaks = 10^(1:10) # vector of (10, 100, 1000, 10000, ...)
    ) +
...
ggplot(iris, aes(Sepal.Width, Sepal.Length)) +
    ...
    theme(axis.text = element_text(size = 16)  ,
          ...
          panel.background = element_rect(fill = "grey")) # change aspects of plot in theme()
```
...
# p %>% 
#    ggplotly() %>% 
#    htmlwidgets::saveWidget("cm013-exercise_files/plotly.html")
```
