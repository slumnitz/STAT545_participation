...
```{r}
tibble(let = letters, # make a tibble/ data frame in tidyverse, generate a column wiht letters
       num = 1:length(letters), # generate the variable numbers that is as long as the alphabet
       comb = paste0(let, num)) # combine both
```

Make a tibble of three names and commute times.

```{r}
tribble( # second way to create a tibble
    ~name, ~time,
    "Frank", 30,
    "Lisa", 15,
    "Fred", 40
